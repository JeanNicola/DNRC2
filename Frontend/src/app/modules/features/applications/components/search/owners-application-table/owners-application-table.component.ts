...
@Component({
  selector: 'app-owners-application-table',
  templateUrl:
    '../../../../../shared/components/templates/code-table/code-table.template.html',
  styleUrls: [
    '../../../../../shared/components/templates/code-table/code-table.template.scss',
    'owners-application-table.component.scss',
  ],
  providers: [SearchApplicantService],
})
export class OwnersApplicationTableComponent extends BaseCodeTableComponent {
  ...
  constructor(
    public service: SearchApplicantService,
