...
@Injectable()
export class UnresolveGeocodesService extends BaseDataService {
  constructor(protected http: HttpClient) {
    super(http);
    this.urlList = ['/water-rights', '/geocodes/unresolve'];
  }

  public unresolve(newRow: any, ...ids: string[]): Observable<any> {
    return this.http
